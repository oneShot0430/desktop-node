...
describe('getTaskMessage', () => {
  ...
  it('should return a message when the task is delisted,  stopped and is private', () => {
    const params = {
      taskIsDelistedAndStopped: true,
      task: { isWhitelisted: true } as Task,
      isBountyEmpty: false,
  ...
  it('should return a message when the task is not whitelisted and is not private', () => {
    const params = {
