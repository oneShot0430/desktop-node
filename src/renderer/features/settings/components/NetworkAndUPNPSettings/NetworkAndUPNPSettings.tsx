...
export function NetworkAndUPNPSettings() {
  ...
  return (
    <div className="overflow-y-auto text-white">
      <SectionHeader title="Enable Networking Features" />
      <div className="text-sm">
        Enable Networking: By toggling this option, you allow tasks that require
        external interactions, such as storage operations and hosting APIs, to
        run on your computer, facilitating seamless collaboration and
        functionality.
      </div>
      <Spacer size="sm" />
      <SwitchWrapper
