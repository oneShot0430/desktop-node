import { Icon, CloseLine, CurrencyMoneyLine } from '@_koii/koii-styleguide';
import { create, useModal } from '@ebay/nice-modal-react';
import React, { useEffect } from 'react';
import { useMutation } from 'react-query';

import { KoiiInputNew } from 'renderer/components/KoiiInput';
import {
  Button,
  ErrorMessage,
  LoadingSpinner,
...
import { fundStakingWalletFromMainWallet } from 'renderer/services';
...
export const AddStakingAccountFunds = create<PropsType>(
  function AddStakingAccountFunds({ onWalletFundSuccess }) {
