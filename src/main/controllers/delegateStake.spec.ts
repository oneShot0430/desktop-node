...
describe('delegateStake', () => {
  ...
  describe('account already exists', () => {
    beforeEach(() => {
      ...
      (getTaskInfo as jest.Mock).mockReturnValue({
        stakePotAccount: new koiiWeb3.PublicKey(
          'Ai5QY8EwZiZ9HPgYTs6QjqyffKxEGF5H9jN11YYWyxwG'
        ),
      });
    });
    ...
    it('sends stake and does not create new account', async () => {
      ...
      expect(koiiWeb3.sendAndConfirmTransaction).toHaveBeenCalledTimes(2);
