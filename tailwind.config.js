  ...
  theme: {
    ...
    extend: {
      ...
      gridTemplateColumns: {
        ...
        'my-node':
          'minmax(52px, 1fr) minmax(200px, 2fr) minmax(68px, 1.5fr) minmax(68px, 1.5fr) minmax(68px, 1fr) minmax(68px, 1fr) minmax(68px, 1.5fr) minmax(182px, 4fr) minmax(68px, 1fr) minmax(68px, 1fr)',
        'available-tasks':
          'minmax(52px, 1fr) minmax(200px, 2fr) minmax(68px, 1.5fr) minmax(68px, 1.5fr) minmax(100px, 1fr) minmax(68px, 1fr) minmax(120px, 2fr) minmax(68px, 1.5fr) minmax(68px, 1fr)',
